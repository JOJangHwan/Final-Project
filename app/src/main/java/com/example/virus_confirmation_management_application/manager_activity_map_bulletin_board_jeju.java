 ...
 */
public class manager_activity_map_bulletin_board_jeju extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.manager_activity_map_bulletin_board_jeju);
        ...
        button_move = findViewById(R.id.button_bulletin_board_jeju); //
        button_move.setOnClickListener(new View.OnClickListener() {
            @Override

            public void onClick(View v) {
                Intent intent = new Intent(manager_activity_map_bulletin_board_jeju.this, manager_activity_map_jeju2.class); //현재 위치와 이동할 위치의 인자
                startActivity(intent); // 액티비티 이동 구문
            }
        });

        button_move = findViewById(R.id.button_map_write_jeju); // 글쓰기
        button_move.setOnClickListener(new View.OnClickListener() {
            @Override

            public void onClick(View v) {
                Intent intent = new Intent(manager_activity_map_bulletin_board_jeju.this, manager_map_write.class); //현재 위치와 이동할 위치의 인자
                startActivity(intent); // 액티비티 이동 구문
            }
        });
    }
